package com.example.alluser.mapper;

import com.example.alluser.pojo.Sys_user;
import com.example.alluser.util.DelStu;
import com.example.alluser.util.Permission;
...
public interface SysUserMapper {
    ...
    public List<Sys_user> findAllUser();
}
